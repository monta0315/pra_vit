...
from patch import PatchEncoder, Patches
...
def create_vit_classifier(data_augumetation):
    inputs = layers.Input(shape=input_shape)
    # Augument data
    augumented = data_augumetation(inputs)
    # create patches
...
def main():
    ...
    vit_classifier = create_vit_classifier(data_augumentation)
